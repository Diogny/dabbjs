 ...
 * @param ch pad char
 */
declare const pad: (t: string, e: number, ch?: any) => string;
/**
 *
 * @param ch char|string to fill
 * @param len repeat count, must be equal or greater than zero
 */
declare const fillChar: (ch: string, len: number) => string;
/**
 ...
 */
declare const tag: (tagName: string, id: string, nsAttrs: {
    [id: string]: any;
}) => SVGElement;
/**
 ...
 */
declare const svg: (html: string) => SVGElement;
/**
 * @description creates an HTML element by an string
 * @param html html string representation
 */
declare const html: (html: string) => HTMLElement;
/**
 ...
 */
declare const arrow: (a: IPoint, b: IPoint, head: number, swipe: number) => {
    ang: number;
    v: Vector2D;
    a: Point;
    b: Point;
 ...
 */
declare const ready: (fn: Function) => boolean;
/**
 * @description document.querySelector shortcut
 * @param selectors query string
 * @param elem HTMLElement or document if undefined
 */
declare const qS: (selectors: string, elem?: HTMLElement | undefined) => HTMLElement;
/**
 * @description document.querySelectorAll shortcut
 * @param selectors query string
 * @param elem HTMLElement or document if undefined
 */
declare const qSA: (selectors: string, elem?: HTMLElement | undefined) => NodeListOf<Element>;
/**
 * @description document.getElementById shortcut
 * @param s #id
 */
declare const gEId: (id: string) => HTMLElement | null;
/**
 * @description extracts a base-name from page metadata
 */
declare const basePath: () => string | null;
/**
 ...
 */
declare const matrix: <T>(rows: number, cols: number, filler: T) => T[][];
/**
